    ...
    Comment: {
      ...
      properties: {
        ...
        internal: {
          ...
          enum: [true],
          description:
            'Should never appear on a response from these routes, and is documented so that a client reading one knows to discard it. It marks a CLS working note — `tbl_order_destination_notes.is_admin = 1`, the box the admin labels “Admin comment” — which is confidential to CLS and filtered out of every client-facing read. It was briefly returned and badged, between 2026-08-26 and 2026-08-27, at CLS’s request and then against it.',
        },
        attachments: {
          type: 'array',
          description:
